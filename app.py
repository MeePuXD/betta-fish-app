...
def find_best_model():
    ...
    for name in ["betta_classifier-v7", "betta_classifier-v6", "betta_classifier-v5", "betta_classifier-v4", "betta_classifier-v3", "betta_classifier-final", "betta_classifier-2", "betta_classifier"]:
